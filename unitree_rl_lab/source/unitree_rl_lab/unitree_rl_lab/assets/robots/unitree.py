...
UNITREE_MODEL_DIR = "/home/wx/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "/home/wx/unitree_ros"  # Replace with the actual path to your unitree_ros package
...
class UnitreeUrdfFileCfg(sim_utils.UrdfFileCfg):
    ...
    def replace_asset(self, meshes_dir, urdf_path):
        ...
        """
        tmp_base_dir = os.path.expanduser("~/.cache/IsaacLab/unitree_rl_lab")
        tmp_meshes_dir = os.path.join(tmp_base_dir, "meshes")
        if os.path.exists(tmp_meshes_dir):
            os.remove(tmp_meshes_dir)
        os.makedirs(tmp_base_dir, exist_ok=True)
        os.symlink(meshes_dir, tmp_meshes_dir)

        self.asset_path = os.path.join(tmp_base_dir, "robot.urdf")
